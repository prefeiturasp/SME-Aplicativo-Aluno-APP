...
const String CREATE_TABLE_MESSAGES_SCRIPT =
    "CREATE TABLE IF NOT EXISTS messages(id INTEGER PRIMARY KEY, mensagem TEXT, titulo TEXT, dataEnvio TEXT, criadoEm TEXT, alteradoEm TEXT, mensagemVisualizada INTEGER, categoriaNotificacao TEXT)";
