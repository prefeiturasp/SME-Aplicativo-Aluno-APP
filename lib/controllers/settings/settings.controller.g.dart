...
mixin _$SettingsController on SettingsControllerBase, Store {
  late final _$dataAtom = Atom(
    name: 'SettingsControllerBase.data',
    context: context,
  );
  ...
  late final _$isLoadingAtom = Atom(
    name: 'SettingsControllerBase.isLoading',
    context: context,
  );
  ...
  late final _$changePasswordAsyncAction = AsyncAction(
    'SettingsControllerBase.changePassword',
    context: context,
  );
  ...
  Future<void> changePassword(String password, String oldPassword, int userId) {
    return _$changePasswordAsyncAction.run(
      () => super.changePassword(password, oldPassword, userId),
    );
  }
