...
mixin _$FirstAccessController on FirstAccessControllerBase, Store {
  late final _$dataAtom = Atom(
    name: 'FirstAccessControllerBase.data',
    context: context,
  );
  ...
  late final _$dataEmailOrPhoneAtom = Atom(
    name: 'FirstAccessControllerBase.dataEmailOrPhone',
    context: context,
  );
  ...
  late final _$currentEmailAtom = Atom(
    name: 'FirstAccessControllerBase.currentEmail',
    context: context,
  );
  ...
  late final _$currentPhoneAtom = Atom(
    name: 'FirstAccessControllerBase.currentPhone',
    context: context,
  );
  ...
  Future<void> changeNewPassword(int id, String password) {
    return _$changeNewPasswordAsyncAction.run(
      () => super.changeNewPassword(id, password),
    );
  }
  ...
  Future<void> loadUserForStorage(int userId) {
    return _$loadUserForStorageAsyncAction.run(
      () => super.loadUserForStorage(userId),
    );
  }
